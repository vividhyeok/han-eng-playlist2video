...
아래 문제 구절의 의미를 확정해 주세요. 웹 검색이 가능하면 반드시 곡 제목, 아티스트, 공식/신뢰 가능한 가사, 인터뷰, 고유명사와 슬랭을 검색하여 확인하세요. 검색으로 확인되지 않는 내용을 지어내지 말고, 주변 가사 문맥과 한국 힙합 용례를 함께 사용하세요. 기존 영어·브랜드·인명·크루명·말장난·욕설의 강도를 보존하고, 영상에서 읽기 좋은 자연스러운 영어 한 줄로 번역하세요.
