...
- 일반 가사는 STT 싱크 초안을 만든 뒤 데스크톱 탭 싱크 화면에서 직접 확인합니다.
- 재생 중 `Space`로 현재 줄의 시작점을 기록하고 방향키로 0.1초씩 보정할 수 있습니다.
- AI가 의미를 확정하지 못한 구절은 원문·질문·임시 번역을 함께 보여주며 직접 수정 후 렌더를 재개합니다.
